...
public class AbstractBaseTest {
    ...
    public void beforeTest(){
        ...
        String reportPath = "";
        //location of report file; they are different for mac and windows,
        // and this if statement helps to resolve these differences
    ...
    public void teardown(ITestResult testResult){
        if(testResult.getStatus() == ITestResult.FAILURE) {
            ...
            try {
                ...
                e.printStackTrace();
                throw new RuntimeException("Failed to attach a screenshot");
            }
